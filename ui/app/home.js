    ...
    >
      ...
      >
        ...
        <View style={{ marginTop: 20, backgroundColor: 'white', paddingHorizontal: 10, paddingVertical: 10, borderRadius: 7 }}>
          ...
          <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', marginTop: 20 }} onPress={() => router.push('/applayleave')}>
            <View
              style={{
                padding: 7,
                width: 45,
            ...
            <Text style={{ margin: 10, fontSize: 16, fontWeight: '600', flex: 1 }}>Apply Leave</Text>
            <View
              style={{
                width: 35,
                height: 35,
          ...
          <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', marginTop: 20 }} onPress={() => router.push('/leavestatus')}>
            <View
              style={{
                padding: 7,
                width: 45,
            ...
            <Text style={{ margin: 10, fontSize: 16, fontWeight: '600', flex: 1 }}>Leave Status</Text>
            <View
              style={{
                width: 35,
                height: 35,
          ...
          <Pressable style={{ backgroundColor: '#BE93C5', borderRadius: 6, padding: 10, flexDirection: 'row', alignItems: 'center', marginTop: 20 }} onPress={() => router.push('/salaryslip')}>
            <View
              style={{
                padding: 7,
                width: 45,
            ...
            <Text style={{ margin: 10, fontSize: 16, fontWeight: '600', flex: 1 }}>Genarate salarySlip</Text>
            <View
              style={{
                width: 35,
                height: 35,
      ...
      >
        ...
        <Text style={{ marginTop: 7 }}>Leave Requests</Text>
      </Pressable>
